...
const sections = [
  {
    title: "Blog & Newsroom",
    description: "Articles on ICT trends, digitalization and the AI era.",
    icon: "M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z",
    status: "Coming soon",
  },
  {
    title: "Demo Library",
    description: "Interactive demonstrations of our platforms and solutions.",
    icon: "M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z M21 12a9 9 0 11-18 0 9 9 0 0118 0z",
    status: "Coming soon",
  },
  {
    title: "Corporate Documentation",
    description: "Annual reports, privacy policies and compliance documentation.",
      ...
      <section class="bg-[#080F1E] pt-20 py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p class="mt-4 max-w-2xl text-lg text-white/60">
            Insights, demos and documentation to keep you informed.
          </p>
        </div>
      </section>
          ...
          <div class="grid gap-8 sm:grid-cols-3">
            {sections.map((section) => (
              <div key={section.title} class="rounded-xl border border-heading/10 bg-white p-8 text-center shadow-sm">
                ...
                <span class="mt-4 inline-block rounded-full bg-heading/10 px-3 py-1 text-xs font-medium text-text">
                  {section.status}
                </span>
              </div>
            ))}
...
export const head: DocumentHead = {
  title: "Resources | Eurosynapse",
  meta: [
    {
      name: "description",
      content: "Eurosynapse resources: blog, newsroom, demo library and corporate documentation.",
    },
  ],
};
